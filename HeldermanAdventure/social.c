...
int executePlay(void)
{
    ...
    if (obj == NULL)
    {
        printf("I dont understand what character you want to play as.\n");
    }
    else if (obj == player)
    {
...
int executeSay(void)
{
    ...
    if (*phrase == '\0')
    {
        printf("I dont undertsand what you want to say.\n");
    }
    else
    {
        printf("You say: %s\n", phrase);
...
int executeWhisper(void)
{
    ...
    if (to != NULL)
    {
        ...
        if (*phrase == '\0')
        {
            printf("I dont understand what you want to whisper.\n");
        }
        else
        {
